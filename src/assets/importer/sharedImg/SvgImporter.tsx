...
export function FaceBook({ className, enableHover=false }: Props) {
    const [dark, setDark] = useState(true);
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" width="20" height="20" onMouseEnter={() => setDark(false)} onMouseLeave={() => setDark(true)}>
            <defs>
                <linearGradient id="facebook" x1="100%" x2="0%" y1="0%" y2="100%">
                    <stop offset="0%" stopColor={dark ? "#fff" : "#63AFDB"} /><stop offset="100%" stopColor={dark ? "#fff" : "#6028F1"} />
                </linearGradient>
            </defs>
